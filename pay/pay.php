...
<html>
<head>
<title>Liberpool | Checkout</title>
...
<body>
	<div class="main">	
		...
		<div class="w3_agile_main_grids">
			<div class="agile_main_top_grid">
				...
				<div class="wthree_total">
					<h2>total to pay <span>--<i>$</i></span></h2>
				</div>
			</div>
							...
							<form action="pays.php" method="post">
								<section class="creditly-wrapper wthree, w3_agileits_wrapper">
									<div class="credit-card-wrapper">
										...
										<button class="submit" type="submit"><span>Make a payment</span></button>
									</div>
								</section>
							</form>
						</div>
		...
		<div class="agileits_copyright">
			<p>© 2017 Liberpool. All rights reserved</p>
		</div>
	</div>
	<!-- credit-card -->
